...
By default the template creates a single `HelloWorld` contract under injected_rewards_pool_flux_gated folder in the `smart_contracts` directory. To add a new contract:
